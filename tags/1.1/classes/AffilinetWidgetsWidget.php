...
class AffilinetWidgetsWidget extends \WP_Widget
{
    ...
    public function form($instance)
    {
        ...
        <p>
            ...
            <button type="button" onclick="openInWidgetsPageInBrowserExtension()" class="button-primary affilinet-browser-extension-show-v2"><?php _e('admin.editInExtension', 'affilinet-product-widgets');?></button>
        </p>
        <?php
    }
